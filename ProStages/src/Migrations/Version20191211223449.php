 ...
 */
final class Version20191211223449 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT NOT NULL, titre VARCHAR(50) NOT NULL, nom VARCHAR(50) NOT NULL, activiter VARCHAR(255) NOT NULL, adresse VARCHAR(50) NOT NULL, description VARCHAR(255) NOT NULL, email VARCHAR(50) NOT NULL, INDEX IDX_C27C9369A4AEAFEA (entreprise_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
